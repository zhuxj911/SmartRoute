...
class TransitionCurveUnitTest {
    ...
    @Test
    fun transitionCurveWithID_ZH_HZ() {
        val r = TransitionCurve(start, jd, end, 1000.0, 80.0)
        ...
        r.zh.let{
            ...
            assertEquals("K5+200.001", it.kNoInfo)
        ...
        r.hy.let{
            ...
            assertEquals("K5+280.001", it.kNoInfo)
        ...
        r.yh.let{
            ...
            assertEquals("K5+379.865", it.kNoInfo)
        ...
        r.hz.let{
            ...
            assertEquals("K5+459.865", it.kNoInfo)
        ...
        assertEquals("10°18′19.71446″", radianToDmsString(r.alpha))
        assertEquals(1, r.flag)
        assertEquals(130.19809566293094, r.T, 1e-3)
        assertEquals(259.864, r.L, 1e-3)
